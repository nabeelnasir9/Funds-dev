...
export function useCreatePassoutRequest() {
  ...
  return useMutation({
    ...
    mutationFn: async (params: CreateUser) => {
      ...
      loadingToast = toast.loading("Adding PassOut Request");
    ...
    onSuccess: (response) => {
      ...
      if (response.message === "success") {
        ...
        toast.success("PassOut request Added");
...
export function userGetPassoutRequest(searchParams?: string) {
  ...
  return useMutation({
    ...
    mutationFn: async (params: any) => {
      toast.dismiss();
      loadingToast = toast.loading("Getting PassOut Request");
    ...
    onSuccess: (response) => {
      ...
      if (response.message === "success") {
        ...
        toast.success("PassOut Request Success");
        // queryClient.invalidateQueries({ queryKey: ['get_users'] })
      } else {
        toast.dismiss();
